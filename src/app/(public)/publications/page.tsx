        ...
        <aside className="w-full md:w-64 flex-shrink-0 space-y-6">
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full border-gray-300 rounded-md shadow-sm focus-visible:ring-primary-500 focus-visible:border-primary-500 sm:text-sm p-2 border"
                >
            ...
            <button
              ...
              className="mt-6 w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus-visible:ring-primary-500"
            >
              Réinitialiser
            </button>
          </div>
        ...
        <div className="flex-1">
          <div className="mb-6 relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus-visible:ring-primary-500 focus-visible:border-primary-500 sm:text-sm shadow-sm"
            />
          </div>
